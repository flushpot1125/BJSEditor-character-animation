...
exports.attachScriptToObjectImmediately = exports.runScene = void 0;
...
function runScene(scene, rootUrl) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            (0, tools_1.attachScripts)(scripts_map_1.scriptsMap, scene);
            // Configure post-processes
            (0, tools_1.configurePostProcesses)(scene, rootUrl);
            // Rendering groups
            (0, tools_1.setupRenderingGroups)(scene);
            // Pose matrices
            (0, tools_1.applyMeshesPoseMatrices)(scene);
            // Apply colliders
            (0, tools_1.applyMeshColliders)(scene);
            return [2 /*return*/];
        });
    });
}
...
function attachScriptToObjectImmediately(scriptPath, object) {
    (0, tools_1.attachScriptToNodeAtRuntime)(scriptPath, object);
}
